...
(function (factory) {
  ...
  return (function () {
    ...
    var defaults = {
      ...
      useFullscreenPopup:
        typeof navigator !== "undefined" && typeof window !== "undefined" // we cannot just test screen size as some smartphones/website meta tags will report desktop
          ? // resolutions
        ...
        },
        {
          ...
          value: function _generateMarkup() {
            ...
            var _this$options = this.options,
              ...
              showSelectedDialCode = _this$options.showSelectedDialCode,
              showFlags = _this$options.showFlags,
              containerClass = _this$options.containerClass,
              hiddenInput = _this$options.hiddenInput,
              dropdownContainer = _this$options.dropdownContainer,
              fixDropdownWidth = _this$options.fixDropdownWidth,
              useFullscreenPopup = _this$options.useFullscreenPopup,
              countrySearch = _this$options.countrySearch;
        ...
        },
        {
          ...
          value: function _setInitialState() {
            ...
            var _this$options2 = this.options,
              ...
              defaultToFirstCountry = _this$options2.defaultToFirstCountry;
        ...
        },
        {
          ...
          value: function _setFlag(iso2) {
            var _this$options3 = this.options,
              ...
              showSelectedDialCode = _this$options3.showSelectedDialCode,
              showFlags = _this$options3.showFlags,
              countrySearch = _this$options3.countrySearch;
        ...
        },
        {
          ...
          value: function _updatePlaceholder() {
            var _this$options4 = this.options,
              autoPlaceholder = _this$options4.autoPlaceholder,
              placeholderNumberType = _this$options4.placeholderNumberType,
              nationalMode = _this$options4.nationalMode,
              customPlaceholder = _this$options4.customPlaceholder;
